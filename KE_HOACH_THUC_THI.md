...
- [ ] **Tuần 5-6:** Hoàn thành Phase 4 (Frontend tích hợp đầy đủ APIs).
- [ ] **Tuần 7:** Hoàn thành Phase 5-6 (QA tổng thể + Deploy production + hồ sơ bàn giao).
...
- [ ] Contrast màu chữ/nền và thành phần tương tác đạt chuẩn **WCAG 2.2 Level AA** cho toàn bộ ứng dụng.
...
- [ ] **Rủi ro thành viên quá tải:** tách việc theo ưu tiên MoSCoW (Must/Should/Could/Won't: Bắt buộc/Nên có/Có thể có/Không làm trong phạm vi hiện tại).
