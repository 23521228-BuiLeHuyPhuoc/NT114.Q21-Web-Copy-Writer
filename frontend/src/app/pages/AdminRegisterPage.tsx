      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-950 px-5">
        <div className="text-center max-w-md">
          ...
          <div className="relative w-28 h-28 mx-auto mb-8">
            ...
            <div className="absolute inset-3 rounded-full bg-amber-500/10 animate-pulse flex items-center justify-center">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5 mb-8 text-left space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Thông tin tài khoản đã được lưu</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 bg-amber-500/20 border-2 border-amber-500 rounded-full flex items-center justify-center flex-shrink-0 animate-pulse">
                <div className="w-2.5 h-2.5 bg-amber-400 rounded-full" />
              </div>
              <div>
                <p className="text-sm font-semibold text-amber-300">Đang chờ Super Admin duyệt</p>
                <p className="text-xs text-gray-500">Có thể mất 24–48 giờ</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 opacity-40">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-400">Kích hoạt & Đăng nhập</p>
                <p className="text-xs text-gray-600">Nhận email thông báo khi được duyệt</p>
              </div>
            </div>
          </div>
          ...
          {/* CTA */}
          <a href="/admin/login">
            <button className="w-full h-12 border border-gray-800 hover:border-gray-700 text-gray-400 hover:text-gray-200 hover:bg-gray-900 rounded-xl font-semibold text-sm transition-all">
              ← Quay lại trang đăng nhập Admin
            </button>
          </a>

          <p className="text-center text-xs text-gray-700 mt-6">
            Liên hệ <span className="text-gray-500">admin@copypro.vn</span> nếu cần hỗ trợ
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen flex bg-gray-950">
      ...
      <div className="hidden lg:flex lg:w-[52%] flex-col relative overflow-hidden">
        ...
        <div className="relative px-12 xl:px-16 pb-10 pt-6 border-t border-white/5">
          <p className="text-gray-600 text-xs">CopyPro Admin Console v2.0 · Chỉ dành cho nhân viên được ủy quyền</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-10 bg-gray-950 overflow-y-auto">
        ...
        <div className="w-full max-w-[400px]">
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm">Tạo tài khoản quản trị viên mới cho hệ thống CopyPro.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Họ tên */}
            <div>
              <Label className="text-gray-400 mb-2 block text-xs uppercase tracking-wider">Họ và tên</Label>
            ...
            <div className="lg:hidden">
              <Label className="text-gray-400 mb-2 block text-xs uppercase tracking-wider">Loại Admin</Label>
              <div className="relative">
                <button
                  type="button"
            ...
            {/* Confirm password */}
            <div>
              <Label className="text-gray-400 mb-2 block text-xs uppercase tracking-wider">Xác nhận mật khẩu</Label>
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-600" />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input type={showCode ? 'text' : 'password'} placeholder="Nhập mã mời từ quản trị viên" value={inviteCode} onChange={e => setInviteCode(e.target.value)}
                  className="pl-10 pr-10 h-12 rounded-xl bg-gray-900 border-gray-700 text-white placeholder:text-gray-600 focus:border-amber-500 focus:bg-gray-800 font-mono tracking-widest" required />
                <button type="button" onClick={() => setShowCode(!showCode)} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-400 transition-colors">
                  {showCode ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                </button>
              </div>
              <p className="text-gray-700 text-[11px] mt-1.5">Demo: <span className="font-mono text-amber-500/70">{ADMIN_INVITE_CODE}</span></p>
            </div>
            ...
            <div className={`${selectedRole.color} border ${selectedRole.borderColor} rounded-xl p-3 flex items-center gap-2.5`}>
              ...
              <div>
                ...
                <p className="text-[11px] text-gray-600">{selectedRole.description}</p>
              </div>
            </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center"><span className="bg-gray-950 px-3 text-xs text-gray-600">Đã có tài khoản?</span></div>
          </div>
          ...
          <p className="text-center text-xs text-gray-700 mt-6">© 2026 CopyPro Vietnam · Hệ thống nội bộ</p>
        </div>
      </div>
    </div>
  );
