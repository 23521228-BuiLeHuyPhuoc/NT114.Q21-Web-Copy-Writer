...
export function ProductInfoForm({ productName, keywords, targetAudience, additionalContext, onChange }: Props) {
  return (
    <Card className="p-4 space-y-3">
      <Label className="text-sm font-semibold text-gray-700 block">Thông tin sản phẩm</Label>
      <div>
        <Label className="text-xs text-gray-600">Tên sản phẩm/dịch vụ</Label>
      ...
      <div>
        <Label className="text-xs text-gray-600">Từ khóa chính</Label>
      ...
      <div>
        <Label className="text-xs text-gray-600">Đối tượng mục tiêu</Label>
      ...
      <div>
        <Label className="text-xs text-gray-600">Thông tin bổ sung</Label>
