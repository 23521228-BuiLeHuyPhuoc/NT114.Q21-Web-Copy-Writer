        ...
        <div className="mt-4 space-y-4">
          <div>
            <div className="flex justify-between mb-2">
              <Label className="text-xs text-gray-600">Số phiên bản ({variations})</Label>
            </div>
          ...
          <div>
            <div className="flex justify-between mb-2">
              <Label className="text-xs text-gray-600">Temperature: {temperature[0]} (sáng tạo)</Label>
            </div>
            <Slider value={temperature} onValueChange={onTemperatureChange} min={0} max={1} step={0.1} />
            <div className="flex justify-between text-xs text-gray-400 mt-1"><span>Chính xác</span><span>Sáng tạo</span></div>
          </div>
        </div>
      )}
    </Card>
